...
def create_app(config=None):
    ...
    app.config.update(
        SQLALCHEMY_DATABASE_URI="sqlite:///users.db", # Set the SQLAlchemy database URI
        SQLALCHEMY_TRACK_MODIFICATIONS=False,
        SECRET_KEY=os.environ.get('Szddau6DuMCq5gV83n0fujqrdtAg9', 'dev'),
    )
    ...
    # Attach User model to app
    app.User = User

    def insert_users():
        """Insert defaults Users"""
        try:
    ...
    # Attach insert_users function to app
    app.insert_users = insert_users
